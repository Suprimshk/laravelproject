...
//$details=[
//'title'=>'bidyajewelles',
//'body'=>'Thank you for Visiting. Remember us for every occasion.'
//];
//\Mail::to('suprimshakya2@gmail.com')->send(new WelcomeEmail($details));
...
Route::get('/product', [App\Http\Controllers\FrontController::class, 'index'])->name('product');
Route::get('detail/{id}','App\Http\Controllers\FrontController@detail'); 
