    ...
    public function index(){
        ...
        if (Auth()->user()->id == '1')
         {    
            ...
            $gallery = \App\Models\Gallery::paginate(5);
            $product = \App\Models\Gallery::orderBy('id','desc')->paginate(5);
           
            
            return view('Admin.adminPannel',['user'=>$user,'gallery'=>$gallery,'product'=>$product]);
        } else {
            dd('Unauthorized');
        }
    }
